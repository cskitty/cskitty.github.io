...
### What can be drawn with Turtle Graphics ?
 ...
 Below are two drawings created using Turtle Graphics. Original author [Jack Dong](https://github.com/PerpetualSmile/Python-Painting-Doraemon/blob/master/Pikachu.py)

 [Pikachu using Python Turtle](/turtle/pikachu/)

 [Doraemon using Python Turtle](/turtle/doraemon/)
